...
import UnitRefBadges from './UnitRefBadges'
...
export default function GrammarRuleBox({ section, unitRefs }: Props) {
  return (
    <div className="mb-8">
      <div className="flex items-start gap-3 mb-3">
        ...
        <div>
          ...
          {unitRefs && unitRefs.length > 0 && <UnitRefBadges unitRefs={unitRefs} className="mt-2" />}
        </div>
      </div>

      <div className={section.label ? 'ml-10 space-y-2' : 'space-y-2'}>
